...
def page1():
    ...
    # load data Airbnb
    df = pd.read_csv("https://raw.githubusercontent.com/afifahrahma22/final-project-big-data/main/data/Airbnb_clean_data.csv")
...
# sidebar
with st.sidebar:
    st.image("https://raw.githubusercontent.com/afifahrahma22/final-project-big-data/main/image/Airbnb_Logo.png") 
